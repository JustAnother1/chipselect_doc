...
this python script works and shows the data recorded for the RP2040.
...
if __name__ == '__main__':
    ...
    restUrl = url + 'microcontroller'

    resp = requests.post(url=restUrl, data=params)
    print('Response: Status code ' + str(resp.status_code))
    print('Request text: ' + str(resp.text))
    if 200 == resp.status_code:
        print('now parsing reply...')
        data = resp.json()
        print(str(data))
    print('Done')
----
